...
VALUES
 ('phone'),('internet'),('login'),('telephone'),('chargeur'),('appareil'),('batterie'),('electrique'),('prise'),('chargement'),('charge'),('rechargement'),('recherche'),('navigateur'),('web'),('information'),('mail'),('email'),('adresse'),('boite'),('creer'),('creation'),('proteger'),('securite'),('fausse'),('proche'),('mots'),('cle'),('utiliser');
